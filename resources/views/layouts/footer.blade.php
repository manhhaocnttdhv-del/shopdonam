            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer__about">
                    <div class="footer__logo">
                        <a href="#"><img src="/temp/assets/img/footer-logo.png" alt=""></a>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="footer__copyright__text">
                    ...
                    <p>Bản quyền © {{ date('Y') }} Tất cả các quyền được bảo lưu | Mẫu thiết kế này được tạo bởi <i class="fa fa-heart-o" aria-hidden="true"></i> bởi <a href="https://colorlib.com" target="_blank">Colorlib</a>
                    </p>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </div>
            </div>
