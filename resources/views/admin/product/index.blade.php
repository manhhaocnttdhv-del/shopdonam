                        ...
                        <div class="modal-dialog" style="max-width: 1440px">
                            <div class="modal-content">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form_product_update form-edit" id="form_product_update-{{$product->id}}" class="form-create" method='POST' enctype="multipart/form-data" action='{{route('products.update',['product' => $product])}}' data-validate="false">
                                        @method('Patch')
                                        @csrf
