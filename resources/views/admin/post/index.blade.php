                ...
                <div class="modal-dialog" style="max-width: 1440px">
                    <div class="modal-content">
                        ...
                        <div class="card-body">
                            ...
                            <form id="form_post_store" class="form-create" method='POST' enctype="multipart/form-data" action='{{route('posts.store')}}' data-validate="false">
                                @csrf
                        ...
                        <div class="modal-dialog" style="max-width: 1440px">
                            <div class="modal-content">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form_post_update form-edit" id="form_post_update-{{$post->id}}" class="form-create" method='POST' enctype="multipart/form-data" action='{{route('posts.update',['post' => $post])}}' data-validate="false">
                                        @method('Patch')
                                        @csrf
