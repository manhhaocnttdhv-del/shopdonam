                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="card-body">
                            ...
                            <form id="form_cate_store" class="form-create" method='POST' action='{{route('cates.store')}}' data-validate="false">
                                @csrf
                                <div class='mb-3'>
                                    <label
                                        class='form-label'
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form_cate_update form-edit" id="form_cate_update-{{$cate->id}}" data-id="{{$cate->id}}" method='post' action='{{ route('cates.update',['cate' => $cate]) }}' data-validate="false">
                                    @method('Patch')
                                    @csrf
                                    <div class='mb-3'>
                                        <label
